...
DEFAULT_SOURCE_DIR = Path("/home/yuan/OIL_PROJECT/dataset/dataset_SAR_2/SAR_2_PNG_relabel_rearrange_Patch/Patched_P1024_O128_BG100p_Separated/SAR_2_PNG_relabel_rearrange")
# 預設的 Model v1 訓練集輸出路徑
DEFAULT_OUTPUT_DIR = Path("/home/yuan/OIL_PROJECT/dataset/dataset_SAR_2/SAR_2_PNG_relabel_rearrange_Patch/HNM_Step1_Model_V1_TrainingSet-P1024")
...
def create_initial_set(source_dir, output_dir, neg_sample_ratio=0.2, val_split_ratio=0.2, random_seed=42):
    ...
    # --- 步驟 2: 獲取並取樣檔案列表 ---
    positive_files = [p.stem for p in pos_img_dir.glob("*.jpg")]
    all_negative_files = [p.stem for p in neg_img_dir.glob("*.jpg")]
    ...
    def copy_files(file_list, dest_img_dir, dest_lbl_dir):
        for base_name in file_list:
            ...
            shutil.copy(src_img_dir / (base_name + '.jpg'), dest_img_dir / (base_name + '.jpg'))
