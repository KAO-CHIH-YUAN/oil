...
if __name__ == '__main__':
    ...
    MODEL_V1_WEIGHTS_PATH = "/home/yuan/OIL_PROJECT/result-rearrange/20250808-034108_HNM_SAR2-Relabel-rearrange_P1024/weights/best.pt"

    # 2. 指定包含【全部】背景負樣本的來源資料夾
    #    這是從 patch_method.py 產生的 _neg 資料夾
    SOURCE_IMAGES_DIRECTORY = "/home/yuan/OIL_PROJECT/dataset/dataset_SAR_2/SAR_2_PNG_relabel_rearrange_Patch/Patched_P1024_O128_BG100p_Separated/SAR_2_PNG_relabel_rearrange/images/train_neg"
    SOURCE_LABELS_DIRECTORY = "/home/yuan/OIL_PROJECT/dataset/dataset_SAR_2/SAR_2_PNG_relabel_rearrange_Patch/Patched_P1024_O128_BG100p_Separated/SAR_2_PNG_relabel_rearrange/labels/train_neg"

    # 3. 指定要將挖掘出的困難負樣本儲存到哪裡
    OUTPUT_DIRECTORY = "/home/yuan/OIL_PROJECT/dataset/dataset_SAR_2/SAR_2_PNG_relabel_rearrange_Patch/HNM_Step2_Negatives_Mined_SAR2_P1024"
