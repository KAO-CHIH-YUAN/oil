...
if __name__ == "__main__":
    ...
    # 提示使用者輸入路徑
    image_folder_path = r"/home/yuan/OIL_PROJECT/dataset/dataset_UAV/partial_5280*2970_dataset/images" # input("請輸入【影像來源資料夾】的路徑: ")
    label_folder_path = r"/home/yuan/OIL_PROJECT/dataset/dataset_UAV/partial_5280*2970_dataset/labels" # input("請輸入【標籤來源資料夾】的路徑: ")
    output_folder_path = r"/home/yuan/OIL_PROJECT/dataset/dataset_UAV/test" #　input("請輸入【輸出資料夾】的路徑: ")
